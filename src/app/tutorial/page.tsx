...
function InteractiveSandbox({
  ...
  return (
    ...
    <div className="fixed inset-x-0 bottom-0 z-50 [transform:translateZ(0)] [will-change:transform] border-t-2 border-[rgba(154,116,72,0.36)] bg-[linear-gradient(180deg,rgba(253,248,241,0.98),rgba(234,221,196,0.98))] px-4 pt-4 pb-[max(1rem,env(safe-area-inset-bottom))] shadow-[0_-14px_34px_rgba(96,72,38,0.18)]">
