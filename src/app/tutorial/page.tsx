...
const STEPS: Step[] = [
  ...
  {
    title: '碰（公开归档）',
    body: '当一张人格牌满足你某个维度的需要时，可以宣布「碰」。规则：\n• 自摸碰（你刚抽到的牌也算自己出的）→ 从手牌中挑选恰好「该维度的目标张数」张同维度牌组合归档；\n• 碰他人弃牌 → 从手牌中挑选恰好「该维度目标张数 − 1」张同维度牌，加上那张弃牌正好凑齐；\n选错维度、混入其他人格牌、张数不对 → 视为「碰失败」。',
    hint: '碰成功后，该维度的牌被公开归档，所有人都能看到，你需要立刻出一张牌。',
  },
  {
    title: '食胡（宣布胜利）',
