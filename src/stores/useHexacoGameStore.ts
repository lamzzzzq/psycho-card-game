...
import { GameState, GameSettings, HexacoScores, PlayerId, Player, Dimension } from '@/types/hexaco-game';
import {
  initializeGame,
  drawCard,
  discardCard,
...
import { makeAIDecision, makeAIHuDecision, makeAIPongDecision, makeAISelfPongDecision } from '@/lib/hexaco-game/ai-engine';
import { delay } from '@/lib/utils';

interface HexacoGameStore {
  game: GameState | null;

  initGame: (humanScores: HexacoScores, settings: GameSettings, humanAvatar?: string) => void;
...
export const useHexacoGameStore = create<HexacoGameStore>()((set, get) => ({
  game: null,
