...
import { GameState, GameSettings, Sd4Scores, PlayerId, Player, Dimension } from '@/types/sd4-game';
import {
  initializeGame,
  drawCard,
  discardCard,
...
import { makeAIDecision, makeAIHuDecision, makeAIPongDecision, makeAISelfPongDecision } from '@/lib/sd4-game/ai-engine';
import { delay } from '@/lib/utils';

interface Sd4GameStore {
  game: GameState | null;

  initGame: (humanScores: Sd4Scores, settings: GameSettings, humanAvatar?: string) => void;
...
export const useSd4GameStore = create<Sd4GameStore>()((set, get) => ({
  game: null,
