// HEXACO PVP 類型（src/types/pvp.ts 的六維物理隔離副本）。字段差異：
// PlayerInfo.hexaco / RoomPlayer.hexaco（對應 players.hexaco 列）、
// SerializedPlayer.hexacoScores、消息 'hexaco-updated'。rooms 基礎設施類型共用結構。
import { HexacoScores, Dimension, GameCard, GameAction, RevealDifficulty } from './hexaco-game';
...
export type RealtimeMessage =
  ...
  | { type: 'hexaco-updated'; playerId: string; hexaco: HexacoScores }
