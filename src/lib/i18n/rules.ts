    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'li', text: 'Semi-Open: view up to 4 hand cards each turn (once viewed, shown permanently); discards not shown.' },
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'li', text: 'Intercept Pong (grab): within another player\'s "read window", if your same-dimension count is "just 1 short" of the target, you can instantly grab that discard to complete the archive! (First-come)' },
          ...
          { t: 'li', text: 'Intercept Win: someone discards the last card you need — intercept it directly!' },
