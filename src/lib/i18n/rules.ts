...
export const RULES_T = {
  zh: {
    ...
    // 配圖文案
    figGoalCap: '圈內數字＝目標張數 → 5 維全部歸檔即食胡並獲勝',
    figFlowDraw: '① 摸 1 張',
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { t: 'p', text: '特別注意：每個維度的目標張數取決於你的測評分數。例如：你的目標可能是 O 需 3 張、C 需 4 張、E 需 2 張、A 需 5 張、N 需 4 張等。' },
  ...
  en: {
    ...
    // figure captions
    figGoalCap: 'The number in each chip = target count → file all 5 dimensions to Win',
    figFlowDraw: '① Draw 1',
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          { t: 'p', text: 'Note: the target count for each dimension depends on your assessment score. Example: your targets might be O needs 3, C needs 4, E needs 2, A needs 5, N needs 4, and so on.' },
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'p', text: 'When you have filed the target counts for all 5 dimensions:' },
