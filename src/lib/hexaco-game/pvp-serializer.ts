// HEXACO PVP 序列化（src/lib/pvp-serializer.ts 的物理隔離副本，僅類型/字段六維化）。
import { SerializedGameState, SerializedPlayer } from '@/types/hexaco-pvp';
import { GameCard } from '@/types/hexaco-game';
