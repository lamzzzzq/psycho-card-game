...
export const STRINGS = {
  zh: {
    ...
    assessment: {
      ...
      gateStart: '開始測評',
      gateChecking: '檢查中…',
      dupWarn: '此學號已有記錄（曾完成測評或手動填分）。若繼續並完成本次測評，將以這次結果為準（覆蓋舊記錄）；中途離開不算覆蓋。確定是你本人、要重做請再按一次。',
  ...
  en: {
    ...
    assessment: {
      ...
      dupWarn: 'This student ID already has a record (a completed assessment or manual scores). If you continue and finish this assessment, this attempt becomes the record (overwriting the old one); leaving midway does not overwrite. If it is really you and want to redo it, press once more.',
