...
export const STRINGS = {
  zh: {
    ...
    home: {
      ...
      title: '人格麻將',
      intro: '結合心理測評與麻將策略。先讀懂自己，再在牌桌上看穿別人！',
      features: [
        { glyph: '✦', title: '性格解鎖', note: '快速完成心理測評，拿到你的專屬人格主場！' },
        { glyph: '◈', title: '摸牌組牌', note: '湊齊同一人格維度的特質牌型，準備食胡！' },
        { glyph: '☽', title: '識人破局', note: '觀察對手的每張打牌，看穿他們的心理線索與心機！' },
        { glyph: '◐', title: '隨時開局', note: '單機與 AI 練習，或隨時開桌與同學真人切磋！' },
      ],
      cardEyebrow: '人格牌陣',
    ...
    pvpLobby: {
      ...
      deckCpaiName: 'Dark Tetrad',
      deckCpaiSub: '四維暗黑人格模型 • 增設「日常施虐」維度',
      alreadyInRoomA: '學號「',
      alreadyInRoomB: '」已在房間 ',
      alreadyInRoomC: ' 中（',
  ...
  en: {
    ...
    home: {
      ...
      features: [
        ...
        { glyph: '☽', title: 'Read Opponents & Outplay', note: 'Observe every card your opponents discard to uncover their psychological clues and strategy!' },
        { glyph: '◐', title: 'Play Anytime', note: 'Practice solo against AI, or set up a table anytime to compete live with fellow students!' },
      ],
    ...
    assessment: {
      ...
      gateRecordFound: 'Assessment record found',
    ...
    game: {
      ...
      youWin: 'You win!',
      winShort: 'wins',
      wonAllDims: 'filed all personality dimensions!',
      roundEndRank: 'Round over! Ranked by filed progress and remaining cards',
      opponent: 'Opponent',
      winSuffix: 'wins',
      declaredSuffix: 'sets',
      ...
      toastPongDupe: 'Duplicate pong! Dimension already filed, hand revealed, next turn skipped',
      ...
      // Pong-intent panel
      pongIntentSelf: 'Self file',
      pongIntentOther: 'File discard',
      ...
      declaredWarn: '⚠️ Already-filed dimension · submitting fails + penalty',
      selfArchive: 'Self-File',
      archiveJudge: 'File',
      // View-cards panel
      ...
      sheetDeclaredTitle: 'Public File',
      sheetLogTitle: 'Action Log',
      noArchiveYet: 'No dimensions filed yet.',
      scoreLabel: 'Score',
      doneLabel: 'Done',
      targetPrefix: 'Target',
      // OpponentHand
      ...
      totalCards: 'total',
      close: 'Close',
      archiveOf: '\'s Public File',
      // DeclaredArea
      archiveRecord: 'Public File',
      noArchiveDone: 'No completed files',
      cardDetail: 'Card Detail',
      personaDesc: 'Personality description',
      noPublicArchive: 'No public file',
      viewWord: 'View',
      archiveWord: 'File',
      // DiscardPile
      ...
      pongCanClaim: 'You may try to complete a personality file from this.',
      ...
      logPongFailDupe: 'dimension already filed (duplicate pong)',
    ...
    pvpLobby: {
      ...
      deckCpaiName: 'Dark Tetrad',
      deckCpaiSub: '4-Dimensional Dark Personality Model • Adds Everyday Sadism',
