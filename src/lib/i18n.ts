...
export const STRINGS = {
  zh: {
    ...
    pvpLobby: {
      ...
      revealLabel: '揭示難度',
      revealOpenName: '明牌',
      revealOpenSub: '全場公開人格',
      revealHalfName: '半公開',
      revealHalfSub: '每回合看 4 張·永久',
      revealHiddenName: '隱藏',
      revealHiddenSub: '每回合看 2 張·一輪消失',
      creating: '創建中…',
      joining: '加入中…',
      code4: '4 位房間碼',
      tabCreate: '創建房間',
  ...
  en: {
    ...
    pvpLobby: {
      ...
      revealOpenName: 'Open',
      revealOpenSub: 'All tags public',
      revealHalfName: 'Half',
      revealHalfSub: 'View 4/turn · kept',
      revealHiddenName: 'Hidden',
      revealHiddenSub: 'View 2/turn · fades',
      creating: 'Creating…',
      joining: 'Joining…',
