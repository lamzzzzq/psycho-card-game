...
export const STRINGS = {
  zh: {
    ...
    assessment: {
      ...
      gateStart: '開始測評',
      gateChecking: '檢查中…',
      dupWarn: '此學號已完成過測評，請確認是否填錯。若確定是你本人、要繼續使用，請再按一次。',
  ...
  en: {
    ...
    assessment: {
      ...
      dupWarn: 'This student ID has already completed the assessment. Please double-check. If it is really you and you want to continue, press once more.',
