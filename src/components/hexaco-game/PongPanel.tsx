...
import { GameCard, Dimension, DIMENSIONS, Player, isPersonalityCard } from '@/types/hexaco-game';
...
import { cardToHexacoProps } from './cardToHexacoProps';
...
export function PongPanel({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        <div className="flex flex-col items-center">
          <div className="rounded-xl p-1" style={{ backgroundColor: 'rgba(200, 155, 93, 0.08)', boxShadow: 'inset 0 0 0 1px rgba(200,155,93,0.18)' }}>
            <HexacoCard {...cardToHexacoProps(pendingCard, locale)} width={108} revealedDimension={revealPendingDimension ? pendingDim : null} />
          </div>
        </div>
      ...
      {/* 六維：移動端 3+3 兩行，≥sm 單行 6 列（與歸檔進度卡同一套響應規則）。 */}
