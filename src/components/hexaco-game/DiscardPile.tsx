...
import { GameCard, GameAction, isPersonalityCard } from '@/types/hexaco-game';
        ...
        {topCard ? (
          <div className="relative">
            ...
            <div className="sm:hidden">
              <HexacoCard {...tarotProps(topCard, locale, revealTags)} width={59} />
            </div>
            <div className="hidden sm:block">
              <HexacoCard {...tarotProps(topCard, locale, revealTags)} width={85} />
            </div>
            {canOpen && (
              <div
                    ...
                    {historyDesc.map((entry, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <HexacoCard {...tarotProps(entry.card, locale, revealTags)} width={84} />
                          </button>
        ...
        {detailCard && (
          <div className="grid gap-5 sm:grid-cols-[auto_1fr] sm:items-center">
            <div className="flex justify-center">
              <HexacoCard {...tarotProps(detailCard, locale, true)} width={200} />
            </div>
