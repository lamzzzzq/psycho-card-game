...
// HEXACO 版游戏内「玩法教學」按钮（HowToPlayButton 的物理隔离副本，内容 = HEXACO_RULES_T）。
...
import { HEXACO_RULES_T } from '@/lib/i18n/hexaco-rules';
import { STRINGS, type Locale } from '@/lib/i18n';
import { PsyOverlayPanel } from '@/components/shared/PsyOverlayPanel';

export function HexacoHowToPlayButton({ locale }: { locale: Locale }) {
