  ...
  return (
    <>
      ...
      <button
        ...
        title={label}
        className="fixed bottom-4 right-4 z-40 flex h-9 w-9 items-center justify-center rounded-full border border-[var(--psy-border)] bg-[#fdf9f0] text-[var(--psy-muted)] shadow-[var(--psy-shadow)] transition hover:text-[var(--psy-accent-strong)]"
      >
        {enabled ? (
          // volume-on
