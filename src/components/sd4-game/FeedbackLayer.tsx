...
import { GameAction, PlayerId } from '@/types/sd4-game';
...
export function useGameFeedback(actions: GameAction[], players: MinimalPlayer[], locale: Locale = 'zh') {
  ...
  useEffect(() => {
    ...
    const dimNameOf = (meta: typeof SD4_GAME_META[keyof typeof SD4_GAME_META] | null) =>
    ...
    if (latest.type === 'pong-success') {
      ...
      const meta = latest.dimension ? SD4_GAME_META[latest.dimension] : null;
      setPops((p) => [
        ...p,
        {
          id: ++popIdRef.current,
