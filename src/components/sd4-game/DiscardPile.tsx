...
import { GameCard, GameAction, isPersonalityCard } from '@/types/sd4-game';
        ...
        {topCard ? (
          <div className="relative">
            ...
            <div className="sm:hidden">
              <Sd4Card {...tarotProps(topCard, locale, revealTags)} width={59} />
            </div>
            <div className="hidden sm:block">
              <Sd4Card {...tarotProps(topCard, locale, revealTags)} width={85} />
            </div>
            {canOpen && (
              <div
                    ...
                    {historyDesc.map((entry, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <Sd4Card {...tarotProps(entry.card, locale, revealTags)} width={84} />
                          </button>
        ...
        {detailCard && (
          <div className="grid gap-5 sm:grid-cols-[auto_1fr] sm:items-center">
            <div className="flex justify-center">
              <Sd4Card {...tarotProps(detailCard, locale, true)} width={200} />
            </div>
