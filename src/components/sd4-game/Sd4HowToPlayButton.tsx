...
// SD4 版游戏内「玩法教學」按钮（HowToPlayButton 的物理隔离副本，内容 = SD4_RULES_T）。
...
import { SD4_RULES_T } from '@/lib/i18n/sd4-rules';
import { STRINGS, type Locale } from '@/lib/i18n';
import { PsyOverlayPanel } from '@/components/shared/PsyOverlayPanel';

export function Sd4HowToPlayButton({ locale }: { locale: Locale }) {
